...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('API Route: Recebendo dados do formulário');
    ...
    console.log('API Route: Resposta do webhook:', {
    ...
    console.log('API Route: Conteúdo da resposta:', responseText);
    ...
    console.error('API Route: Erro ao processar webhook:', error);
